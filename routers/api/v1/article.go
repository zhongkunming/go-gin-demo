...
import (
	...
	"go-gin/pkg/setting"
	"go-gin/pkg/util"
	"go-gin/services/article_service"
	"log"
	"net/http"
)
...
func AddArticle(c *gin.Context) {
	...
	coverImageUrl, _ := c.FormFile("cover_image_url")
	...
	valid.MaxSize(coverImageUrl, setting.AppSetting.ImageMaxSize, "太大")
	valid.Required(coverImageUrl, "cover_image_url").Message("不能为空")
